...
/* Wrapper for WPS operations */
static int iwinfo_L_wps(lua_State *L, int (*func)(const char *, const char *, const char *))
{
	int mode;
	const char *ifname = luaL_checkstring(L, 1);
