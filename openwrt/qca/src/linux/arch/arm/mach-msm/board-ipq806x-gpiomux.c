...
static struct gpiomux_setting ipq806x_leds_low_cfg = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_2MA,
	.pull = GPIOMUX_PULL_UP,
	.dir = GPIOMUX_OUT_LOW, 
...
static struct gpiomux_setting ipq806x_leds_high_cfg = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_2MA,
	.pull = GPIOMUX_PULL_UP,
	.dir = GPIOMUX_OUT_HIGH,
...
static struct msm_gpiomux_config ipq806x_ap148_gpiomux_c2600[] = {
	ipq_mux( 0, mdio_n,				mdio_n),
	ipq_mux( 1, mdio_n,				mdio_n),
	ipq_mux( 2, nss_gmac0_rgmii_set0,		nss_gmac0_rgmii_set0),
	ipq_mux( 3, pcie_rst_n,				    pcie_rst_n),
	ipq_mux( 6, ipq806x_leds_low_cfg,		ipq806x_leds_low_cfg),
	ipq_mux( 7, ipq806x_leds_low_cfg,		ipq806x_leds_low_cfg),
	ipq_mux( 8, ipq806x_leds_low_cfg,		ipq806x_leds_low_cfg),
	ipq_mux( 9, ipq806x_leds_low_cfg,		ipq806x_leds_low_cfg),
	ipq_mux(12, gsbi4_active_cfg,			gsbi4_suspended_cfg),
	ipq_mux(13, gsbi4_active_cfg,			gsbi4_suspended_cfg),
	ipq_mux(16, ipq806x_buttons_cfg,		ipq806x_buttons_cfg),
	ipq_mux(18, gsbi5_spi_data_cfg,			gsbi5_spi_data_cfg),
	ipq_mux(19, gsbi5_spi_data_cfg,			gsbi5_spi_data_cfg),
	ipq_mux(20, gsbi5_spi_cs_cfg,			gsbi5_spi_cs_cfg),
	ipq_mux(21, gsbi5_spi_clk_cfg,			gsbi5_spi_clk_cfg),
	...
	ipq_mux(25, gsbi2_spi_data_cfg,			gsbi2_spi_data_cfg),
	ipq_mux(26, ipq806x_leds_high_cfg,		ipq806x_leds_high_cfg),
	ipq_mux(27, nss_gmac1_rgmii_set,		nss_gmac1_rgmii_set),
	ipq_mux(28, nss_gmac1_rgmii_set,		nss_gmac1_rgmii_set),
	ipq_mux(29, nss_gmac1_rgmii_set,		nss_gmac1_rgmii_set),
	ipq_mux(30, nss_gmac1_rgmii_set,		nss_gmac1_rgmii_set),
	ipq_mux(31, nss_gmac1_rgmii_set,		nss_gmac1_rgmii_set),
	ipq_mux(32, nss_gmac1_rgmii_set,		nss_gmac1_rgmii_set),
	ipq_mux(33, ipq806x_leds_high_cfg,		ipq806x_leds_high_cfg),
	ipq_mux(48, pcie_rst_n,				    pcie_rst_n),
	ipq_mux(51, nss_gmac1_rgmii_set,		nss_gmac1_rgmii_set),
	ipq_mux(52, nss_gmac1_rgmii_set,		nss_gmac1_rgmii_set),
	ipq_mux(53, ipq806x_leds_low_cfg,		ipq806x_leds_low_cfg),
	...
	ipq_mux(66, ipq806x_leds_low_cfg,		ipq806x_leds_low_cfg),
};

static struct msm_gpiomux_config ipq806x_ap148_gpiomux_ad7200[] = {
	ipq_mux( 0, mdio_n,				mdio_n),
	ipq_mux( 1, mdio_n,				mdio_n),
	ipq_mux(2, ipq806x_leds_low_cfg,       ipq806x_leds_low_cfg),
	ipq_mux( 3, pcie_rst_n,                  pcie_rst_n),
	ipq_mux( 6, ipq806x_leds_high_cfg,		ipq806x_leds_high_cfg),
	ipq_mux( 7, ipq806x_buttons_cfg,		ipq806x_buttons_cfg),
	ipq_mux( 8, ipq806x_leds_low_cfg,		ipq806x_leds_low_cfg),
	ipq_mux( 9, ipq806x_leds_high_cfg,		ipq806x_leds_high_cfg),
	ipq_mux(12, gsbi4_active_cfg,			gsbi4_suspended_cfg),
	ipq_mux(13, gsbi4_active_cfg,			gsbi4_suspended_cfg),
	ipq_mux(15, ipq806x_leds_low_cfg,      ipq806x_leds_low_cfg),
	ipq_mux(16, ipq806x_leds_low_cfg,		ipq806x_leds_low_cfg),
	ipq_mux(17, ipq806x_leds_low_cfg,      ipq806x_leds_low_cfg),
	ipq_mux(18, gsbi5_spi_data_cfg,			gsbi5_spi_data_cfg),
	ipq_mux(19, gsbi5_spi_data_cfg,			gsbi5_spi_data_cfg),
	ipq_mux(20, gsbi5_spi_cs_cfg,			gsbi5_spi_cs_cfg),
	ipq_mux(21, gsbi5_spi_clk_cfg,			gsbi5_spi_clk_cfg),
	...
	ipq_mux(51, nss_gmac1_rgmii_set,		nss_gmac1_rgmii_set),
	ipq_mux(52, nss_gmac1_rgmii_set,		nss_gmac1_rgmii_set),
	ipq_mux(53, ipq806x_buttons_cfg,		ipq806x_buttons_cfg),
	ipq_mux(54, ipq806x_buttons_cfg,		ipq806x_buttons_cfg),
	ipq_mux(55, ipq806x_leds_low_cfg,     ipq806x_leds_low_cfg),
	ipq_mux(56, ipq806x_leds_low_cfg,		ipq806x_leds_low_cfg),
	ipq_mux(57, ipq806x_buttons_cfg,           ipq806x_buttons_cfg),
	ipq_mux( 58, nss_gmac0_rgmii_set0,       nss_gmac0_rgmii_set0),
	ipq_mux(59, nss_gmac1_rgmii_set,		nss_gmac1_rgmii_set),
	ipq_mux(60, nss_gmac1_rgmii_set,		nss_gmac1_rgmii_set),
	ipq_mux(61, nss_gmac1_rgmii_set,		nss_gmac1_rgmii_set),
	ipq_mux(62, nss_gmac1_rgmii_set,		nss_gmac1_rgmii_set),
	...
	ipq_mux(65, ipq806x_buttons_cfg,        ipq806x_buttons_cfg),
	ipq_mux(66, ipq806x_leds_low_cfg,     ipq806x_leds_low_cfg),
	ipq_mux(67, ipq806x_buttons_cfg,        ipq806x_buttons_cfg),
	ipq_mux(68, ipq806x_leds_high_cfg,     ipq806x_leds_high_cfg),
};
...
void __init ipq806x_init_gpiomux(void)
{
	...
	if (machine_is_ipq806x_db149() || machine_is_ipq806x_db149_2xx()) {
		...
		if (machine_is_tplink_c2600())
			msm_gpiomux_install(ipq806x_ap148_gpiomux_c2600,
				ARRAY_SIZE(ipq806x_ap148_gpiomux_c2600));
		else if (machine_is_tplink_ad7200())
			msm_gpiomux_install(ipq806x_ap148_gpiomux_ad7200,
				ARRAY_SIZE(ipq806x_ap148_gpiomux_ad7200));
		else
