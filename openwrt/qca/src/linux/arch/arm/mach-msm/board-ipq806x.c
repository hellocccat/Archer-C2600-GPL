...
static void __init ipq806x_calculate_reserve_sizes(void)
{
	...
	msm_reserve_memory(0x44800000, 32*1024*1024);
#endif
...
void ipq806x_pcie_pdata_fixup(void)
{
	...
	if (machine_is_ipq806x_ap148() ||
		...
		if (machine_is_tplink_c2600()) {
				#define PCIE_1_WAKE_N_GPIO_C2600	54
				msm_pcie_platform_data[1].wake_n = PCIE_1_WAKE_N_GPIO_C2600;
				rst[2] = -1;
				pwr[2] = -1;
				no_vreg[2] = 1;
		}
...
static struct gpio_led ap148_gpio_leds_c2600[] = {
	{
		.name       = "lan:blue",
		.gpio       = 6,
		.active_low = 0,
...
static struct gpio_led ap148_gpio_leds_ad7200[] = {
	{
		.name       = "lan:blue",
		.gpio       = 2,
		.active_low = 0,
...
#define AP148_GPIO_BTN_JUMPSTART_C2600	65
#define AP148_GPIO_BTN_RESET_C2600		64
#define AP148_GPIO_BTN_WIRELESS_C2600         49
#define AP148_GPIO_BTN_LEDGENERAL_C2600       16

static struct gpio_keys_button ap148_gpio_keys_c2600[] = {
	{
		.desc		= "wps",
		.type		= EV_KEY,
		.code		= KEY_WPS_BUTTON,
		.debounce_interval = AP148_KEYS_DEBOUNCE_INTERVAL,
		.gpio		= AP148_GPIO_BTN_JUMPSTART_C2600,
		.wakeup		= 1,
		.active_low	= 1,
	},
	{
		...
		.code		= KEY_WLAN,
		.debounce_interval = AP148_KEYS_DEBOUNCE_INTERVAL,
		.gpio		= AP148_GPIO_BTN_WIRELESS_C2600,
		.wakeup		= 1,
		.active_low	= 1,
	},
	{
		...
		.code		= KEY_RESTART,
		.debounce_interval = AP148_KEYS_DEBOUNCE_INTERVAL,
		.gpio		= AP148_GPIO_BTN_RESET_C2600,
		.wakeup		= 1,
		.active_low	= 1,
	},
	{
		...
		.code		= KEY_DOLLAR,
		.debounce_interval = AP148_KEYS_DEBOUNCE_INTERVAL,
		.gpio		= AP148_GPIO_BTN_LEDGENERAL_C2600,
		.wakeup		= 1,
		.active_low	= 1,
	}
};

#define AP148_GPIO_BTN_JUMPSTART_AD7200		67
#define AP148_GPIO_BTN_RESET_AD7200		7
#define AP148_GPIO_BTN_WIRELESS_AD7200  	54
#define AP148_GPIO_BTN_LEDGENERAL_AD7200 	53

static struct gpio_keys_button ap148_gpio_keys_ad7200[] = {
	{
		.desc		= "wps",
		.type		= EV_KEY,
		.code		= KEY_WPS_BUTTON,
		.debounce_interval = AP148_KEYS_DEBOUNCE_INTERVAL,
		.gpio		= AP148_GPIO_BTN_JUMPSTART_AD7200,
		.wakeup		= 1,
		.active_low	= 1,
	},
	{
		...
		.code		= KEY_WLAN,
		.debounce_interval = AP148_KEYS_DEBOUNCE_INTERVAL,
		.gpio		= AP148_GPIO_BTN_WIRELESS_AD7200,
		.wakeup		= 1,
		.active_low	= 1,
	},
	{
		...
		.code		= KEY_RESTART,
		.debounce_interval = AP148_KEYS_DEBOUNCE_INTERVAL,
		.gpio		= AP148_GPIO_BTN_RESET_AD7200,
		.wakeup		= 1,
		.active_low	= 1,
	},
	{
		...
		.code		= KEY_DOLLAR,
		.debounce_interval = AP148_KEYS_DEBOUNCE_INTERVAL,
		.gpio		= AP148_GPIO_BTN_LEDGENERAL_AD7200,
		.wakeup		= 1,
		.active_low	= 1,
	}
};

static struct gpio_led_platform_data gpio_led_ap148_pdata_c2600 = {
	.leds		= ap148_gpio_leds_c2600,
	.num_leds	= ARRAY_SIZE(ap148_gpio_leds_c2600),
};

static struct platform_device ap148_leds_gpio_c2600 = {
	.name	= "leds-gpio",
	.id	= -1,
	.dev	= {
		.platform_data	= &gpio_led_ap148_pdata_c2600,
	},
};

static struct gpio_led_platform_data gpio_led_ap148_pdata_ad7200 = {
	.leds		= ap148_gpio_leds_ad7200,
	.num_leds	= ARRAY_SIZE(ap148_gpio_leds_ad7200),
};

static struct platform_device ap148_leds_gpio_ad7200 = {
	.name	= "leds-gpio",
	.id	= -1,
	.dev	= {
		.platform_data	= &gpio_led_ap148_pdata_ad7200,
	},
};

static struct gpio_keys_platform_data ap148_keys_data_c2600 = {
	.buttons        = ap148_gpio_keys_c2600,
	.nbuttons       = ARRAY_SIZE(ap148_gpio_keys_c2600),
};

static struct platform_device ap148_kp_pdev_c2600 = {
	.name           = "gpio-keys",
	.id             = -1,
	.dev            = {
		.platform_data  = &ap148_keys_data_c2600,
	},
};

static struct gpio_keys_platform_data ap148_keys_data_ad7200 = {
	.buttons        = ap148_gpio_keys_ad7200,
	.nbuttons       = ARRAY_SIZE(ap148_gpio_keys_ad7200),
};

static struct platform_device ap148_kp_pdev_ad7200 = {
	.name           = "gpio-keys",
	.id             = -1,
	.dev            = {
		.platform_data  = &ap148_keys_data_ad7200,
	},
};
...
unsigned int __machine_tplink_type;
...
static void __init ipq806x_init(void)
{
	...
	tplink_match_id = smem_alloc(SMEM_HLOS_MACHID, sizeof(u32));
    if (tplink_match_id) {
        machine_tplink_type = tplink_match_id[1];
        switch (machine_tplink_type) {
            case 0x00260001:
                printk("TP-LINK Archer C2600 v1\n");
                break;
            case 0x00720001:
                printk("TP-LINK Archer AD7200 v1\n");
                break;
            default:
                machine_tplink_type = 0;
                printk("Unknow Board\n");
                break;
        }
    }
    ...
    if (machine_is_tplink_c2600() || machine_is_tplink_ad7200())
    {
        pr_err("Force flash_type from %d to %d!\n", *flash_type_ptr, SMEM_FLASH_SPI);
        *flash_type_ptr = SMEM_FLASH_SPI;
    }
	...
	if (machine_is_ipq806x_ap148() || machine_is_ipq806x_ap148_1xx()) {
		if (machine_is_tplink_c2600()) {
			platform_device_register(&ap148_kp_pdev_c2600);
			platform_device_register(&ap148_leds_gpio_c2600);
		} else if (machine_is_tplink_ad7200()) {
			platform_device_register(&ap148_kp_pdev_ad7200);
			platform_device_register(&ap148_leds_gpio_ad7200);
		} else {
