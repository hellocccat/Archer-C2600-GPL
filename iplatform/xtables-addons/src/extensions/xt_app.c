...
{   
    ...
    /*if (((((pAppInfo->appidntfy_flag[IP_CT_DIR_ORIGINAL].app_id_index) & 0x0fff) != 0x0fff) &&
        (((pAppInfo->appidntfy_flag[IP_CT_DIR_ORIGINAL].app_id_index) & 0x0fff) != 0x0ffe)) ||
        ((((pAppInfo->appidntfy_flag[IP_CT_DIR_ORIGINAL].app_id_index) & 0xf000) != 0xf000) &&
        (((pAppInfo->appidntfy_flag[IP_CT_DIR_ORIGINAL].app_id_index) & 0xf000) != 0xe000)))
    {
        log(MOD_QOS, 1, LP_UINT32HEX, pAppInfo->appidntfy_flag[IP_CT_DIR_ORIGINAL].app_id_index);
    }

    if (((((pAppInfo->appidntfy_flag[IP_CT_DIR_REPLY].app_id_index) & 0x0fff) != 0x0fff) &&
        (((pAppInfo->appidntfy_flag[IP_CT_DIR_REPLY].app_id_index) & 0x0fff) != 0x0ffe)) ||
        ((((pAppInfo->appidntfy_flag[IP_CT_DIR_REPLY].app_id_index) & 0xf000) != 0xf000) &&
        (((pAppInfo->appidntfy_flag[IP_CT_DIR_REPLY].app_id_index) & 0xf000) != 0xe000)))
    {
        log(MOD_QOS, 1, LP_UINT32HEX, pAppInfo->appidntfy_flag[IP_CT_DIR_REPLY].app_id_index);
    }*/
