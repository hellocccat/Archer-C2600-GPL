...
enum ECOpCodes {
	...
	EC_OP_FRIEND                        = 0x57,
	EC_OP_SET_LOG_LEVEL                 = 0x58,
	EC_OP_SET_RATE_PRINT                = 0x59,
	EC_OP_GET_DLOAD_QUEUE_SIMPLE        = 0x60,
	EC_OP_DLOAD_QUEUE_SIMPLE            = 0x61
};
...
enum ECTagNames {
	...
	EC_TAG_ECID                               = 0x000F,
	EC_TAG_LOG_SET_DEBUG                      = 0x0010,
	EC_TAG_SET_RATE_PRINT					  = 0x0011,
	...
	EC_TAG_PARTFILE                           = 0x0300,
		...
		EC_TAG_PARTFILE_UP_SPEED                  = 0x0323,
...
wxString GetDebugNameECOpCodes(uint8 arg)
{
	switch (arg) {
		...
		case 0x58: return wxT("EC_OP_SET_LOG_LEVEL");
		case 0x59: return wxT("EC_OP_SET_RATE_PRINT");
		case 0x60: return wxT("EC_OP_GET_DLOAD_QUEUE_SIMPLE");
		case 0x61: return wxT("EC_OP_DLOAD_QUEUE_SIMPLE");
		default: return CFormat(wxT("unknown %d 0x%x")) % arg % arg;
	}
}
...
wxString GetDebugNameECTagNames(uint16 arg)
{
	switch (arg) {
		...
		case 0x0010: return wxT("EC_TAG_LOG_SET_DEBUG");
		case 0x0011: return wxT("EC_TAG_SET_RATE_PRINT");
		...
		case 0x0323: return wxT("EC_TAG_PARTFILE_UP_SPEED");
...
wxString GetDebugNameEC_DETAIL_LEVEL(uint8 arg)
{
	switch (arg) {
		...
		case 0x05: return wxT("EC_DETAIL_HTTPD");
		default: return CFormat(wxT("unknown %d 0x%x")) % arg % arg;
	}
}
