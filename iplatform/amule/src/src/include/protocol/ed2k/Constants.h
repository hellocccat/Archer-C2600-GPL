...
#define	CONNECTION_TIMEOUT			30000	// set this lower if you want less connections at once, set  it higher if you have enough sockets (edonkey has its own timout too, so a very high value won't effect this)
...
#define	MAX_UP_CLIENTS_ALLOWED		50	/*250 zengwei mod*/	// max. clients allowed regardless UPLOAD_CLIENT_DATARATE or any other factors. Don't set this too low, use DATARATE to adjust uploadspeed per client
...
//#define	TRACKED_CLEANUP_TIME		HR2MS(1) //zengwei mod
//#define	KEEPTRACK_TIME				HR2MS(2) //zengwei mod how long to keep track of clients which were once in the uploadqueue
#define	TRACKED_CLEANUP_TIME		MIN2MS(20) 
#define	KEEPTRACK_TIME				HR2MS(1) // how long to keep track of clients which were once in the uploadqueue
